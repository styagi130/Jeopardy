...
from sklearn import ensemble, metrics, model_selection, feature_extraction
...
if __name__=="__main__":
    parser = argparse.ArgumentParser(description="Use this script to train logistic regression model. Example: python3.8 train_random_forest.py <input_filepath>")
